...
from .derive_catalog import exercise_catalog_elo_base_frame, exercise_metadata_frame
...
def build_agg_exercise_elo_from_fact(
    ...
    stats = (
        ...
        if stats_rows
        else _empty_exercise_elo_df().select(
            [
                "exercise_id",
                "exercise_elo",
                "calibration_attempts",
    ...
    return _finalize_exercise_elo_frame(base, stats)
